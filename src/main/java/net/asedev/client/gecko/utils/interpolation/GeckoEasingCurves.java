 ...
 * @Disclaimer = Custom linear splines used for animation purposes... Made after the Blockbench GeckoLib ones.
 */
public class GeckoEasingCurves
{
    ...
    {
        return (end - start) * (1 - Math.cos((float) (t * Math.PI / 2))) + start;
    }
    ...
    public static double easeInElastic(double start, double end, double t)
    {
        ...
        return start - Math.pow(2, 10 * t - 10) * Math.sin((float) ((t * 10 - 10.75) * c4)) * (end - start);
    }
    ...
    {
        return (end - start) * Math.sin((float) (t * Math.PI / 2)) + start;
    }
    ...
    public static double easeOutElastic(double start, double end, double t)
    {
        ...
        return (end - start) * (Math.pow(2, -10 * t) * Math.sin((float) ((t * 10 - 0.75) * ((2 * Math.PI) / 3))) + 1) + start;
    }
    ...
    {
        return (end - start) * (-(Math.cos((float) (Math.PI * t)) - 1) / 2) + start;
    }
    ...
    public static double easeInOutElastic(double start, double end, double t)
    {
        ...
        if (t < 0.5)
        {
            return start - (Math.pow(2, 20 * t - 10) * Math.sin((float) ((20 * t - 11.125) * c5))) / 2;
        }

        else
        {
            return start + (Math.pow(2, -20 * t + 10) * Math.sin((float) ((20 * t - 11.125) * c5))) / 2 + (end - start);
        }
    }
